        ...
        <Row>
          <Col className="dashboard-menus" md={12}>
            <nav className="site-nav">
              <ul>
                <li
                  className={this.state.currentTab == "buyer" ? "active" : ""}
                >
                  <a
                    href="javaScript:void(0)"
                    onClick={() => this.changeTab("buyer")}
                  >
                    Buyer
                  </a>
                </li>
                <li
                  className={this.state.currentTab == "seller" ? "active" : ""}
                >
                  <a
                    href="javaScript:void(0)"
                    onClick={() => this.changeTab("seller")}
                  >
                    Seller
                  </a>
                </li>
          ...
          <Row>
            <Col md={12} className="buyer">
              ...
              <button
                ...
                onClick={this.navigateToBuyer.bind(this)}
              >
                Check Stats
              </button>
            </Col>
